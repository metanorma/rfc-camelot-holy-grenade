...
image:https://img.shields.io/travis/metanorma/rfc-camelot-holy-grenade/master.svg[
	Build Status, link="https://travis-ci.org/metanorma/rfc-camelot-holy-grenade"]

This Internet-Draft is written in
https://datatracker.ietf.org/doc/draft-ribose-asciirfc/[AsciiRFC]
using the excellent
https://github.com/metanorma/asciidoctor-rfc[`asciidoctor-rfc` gem].
